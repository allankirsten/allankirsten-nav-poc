...
sections:
  - heading: "Impact first"
    summary: >
      Break even in the first year, with own capital, in a physical,
      seasonal business. 7,485 people served over the summer, NPS 71, 4.6
      on Google.
    visual: "Isolated block: NPS 71, Google 4.6"
  - heading: "How I treated a bar like a product"
    summary: >
      Business plan with startup logic, unit economics, cost of goods per
      product, break-even point. Brand built from scratch, from visual
      identity to menu, including production of more than 20 live music
      events.
  - heading: "The revenue engine"
    summary: >
      Burger, draft beer and charcuterie board made up 73% of revenue.
      January alone concentrated 38% of the period's sales, which defined
      where to invest.
    visual: "Isolated block: 73% of revenue in 3 products"
  - heading: "Reflection"
    summary: >
      NPS 71 and Google 4.6 validated the experience. The expansion, though,
      never got captured, the exit came right after the season instead.
      Direct evidence of thinking business before thinking screen.
---
...
The business plan followed startup logic: unit economics, cost of goods per product, break-even point, revenue projection by season. The menu got set by margin, with a conscious decision to keep the IPA draft beer as a positioning product, not a margin product, to stand apart from the competitor. Then came the management routine, a weekly results meeting to keep the numbers honest.
