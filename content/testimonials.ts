...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    name: "Fabio Witt",
    role: "Co-founder & CPO",
    company: "Vobi / MAR Ventures",
  },
  {
    quote: "Allan is an extremely focused and competent professional. He can add great references, manage the team always seeking the best solution and even diving into projects making them beautiful, functional and full of nice details.",
    name: "Bruno Marques",
    role: "Product Designer",
    company: "Cayena",
  },
  {
    quote: "As a Design leader, Allan gives the team a lot of autonomy while guaranteeing the strategy through frequent feedback sessions.",
    name: "Fabio Oliveira",
